...
const tripData = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: "13:30 - 14:15", type: "transport", title: "前往 Outlet", desc: "搭巴士 442 去 Birkenhead Point (HK$40)。", nav: "The Mill, 41-43 Bourke Rd, Alexandria NSW 2015, Australia", tips: "實際車程 16min。" },
      { time: "14:15 - 15:15", type: "shop", title: "Birkenhead Point Outlet", desc: "重點: Lululemon (評價4.4/5)。", nav: "The Mill, 41-43 Bourke Rd, Alexandria NSW 2015, Australia", highlight: "必買", tips: "特價多但排隊長。" },
